...
class ServicesState extends State<Services> {
  ...
  List<DropdownMenuItem<String>> _dropDownMenuItems = [
    new DropdownMenuItem(
        value: 'Add from Available Services',
        child: new Text('Add from Available Services'))
  ];
  String _current = 'Add from Available Services';
  List<String> _exp = ['Beginner', 'Intermediate', 'Advanced']; // Option 2
  String _expLvl;
              ...
              child: Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        DropdownButton(
                          hint: Text(
                              'Add your Experience Level'), // Not necessary for Option 1
                          value: _expLvl,
                          onChanged: (newValue) {
                            setState(() {
                              _expLvl = newValue;
