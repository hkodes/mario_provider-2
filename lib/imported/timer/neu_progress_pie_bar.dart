...
import 'package:mario_provider/imported/timer/neu_progress_painter.dart';
import 'package:mario_provider/imported/timer/screen.dart';
        ...
        children: <Widget>[
          ...
          Center(
            child: Container(
              ...
              child: Center(
                  child: Text(
                      "${(Provider.of<TimerService>(context).currentDuration.inHours % 24)} hours\n"
                      "${(Provider.of<TimerService>(context).currentDuration.inMinutes % 60)} min\n"
                      "${(Provider.of<TimerService>(context).currentDuration.inSeconds % 60)} sec")),
            ),
          ),
        ],
      ),
